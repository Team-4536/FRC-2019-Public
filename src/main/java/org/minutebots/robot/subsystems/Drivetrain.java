...
public class Drivetrain extends PIDSubsystem {
    ...
    public void periodic() {
        ...
        if (getCurrentCommand() == null) {
            ...
            mecanumDrive(OI.strafe.get() ? Constants.VISION_STRAFE_P * VisionCommunication.getInstance().getAngle() : Utilities.accelLimit(xThrottle, pXThrottle),
            Utilities.accelLimit(yThrottle, pYThrottle), turnThrottle, !OI.strafe.get());
        }
