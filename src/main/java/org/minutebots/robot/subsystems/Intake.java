...
public class Intake extends Subsystem {
    ...
    private DoubleSolenoid Velcro2;
    private DoubleSolenoid Cone;
    public static Intake intake = new Intake();

    private Intake(){
        Velcro1 = new DoubleSolenoid(RobotMap.INTAKE_1_1, RobotMap.INTAKE_1_2);
        Velcro2 = new DoubleSolenoid(RobotMap.INTAKE_2_1, RobotMap.INTAKE_2_2);
    ...
    public void setIntakeStatus(boolean out){
        if (out){
            ...
            Velcro2.set(DoubleSolenoid.Value.kForward);
        }
        else if (! out){
            Velcro1.set(DoubleSolenoid.Value.kReverse);
            Velcro2.set(DoubleSolenoid.Value.kReverse);
        }
    }
